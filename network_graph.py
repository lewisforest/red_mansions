...
ANCHOR_GRAPH = {
    ...
    "YINGLIAN_LOST": {
        "year_offset": 2,
        "desc": "英莲五岁元宵节被拐，葫芦庙火灾，甄家随后败落投靠封肃",
    },
    ...
    "DAIYU_ENTER_JIA": {
        "year_offset": 5,
        "desc": "黛玉抛父进京入荣国府（约6岁）；贾雨村同京复职，初见宝玉",
    },
    "XUE_PAN_MURDER_CASE": {
        "year_offset": 6,
        "desc": "拐子将11-12岁英莲先卖冯渊又卖薛蟠，薛蟠打死冯渊；冯家告状拖延了一整年",
    },

    # ------------------ 3. 薛家进京与多线交汇（7 年） ------------------
    "XUE_FAMILY_ARRIVE": {
        "year_offset": 7,
        "desc": "贾雨村到任应天府葫芦案结案，英莲改名香菱（约12-13岁）；薛家举家入京住进荣国府",
    },

    # ------------------ 4. 秦可卿之死与林如海丧事（8 ~ 9 年：极重要网络枢纽） ------------------
    "JIA_LIAN_TAKES_DAIYU_SOUTH": {
        "year_offset": 8,
        "desc": "林如海在扬州重病，贾母命贾琏带黛玉南下探亲（黛玉离开贾府线起点）",
    },
    "QIN_KEQING_DEATH": {
        "year_offset": 9,
        "desc": "秦可卿病逝出殡；同期林如海在扬州病逝，贾琏带黛玉扶柩并处理遗产返回贾府",
    },
    ...
    "BAOCHAI_AGE_15": {
        "year_offset": 12,
        "desc": "薛宝钗十五岁及笄过生日（第22回硬核数字）；秋季海棠诗社成立，刘姥姥二进荣国府",
    },
    "XIANGLING_POETRY": {
        "year_offset": 13,
        "desc": "薛蟠远行外出经商，香菱入大观园住蘅芜苑，拜林黛玉为师学诗（英莲线与黛玉线再次高频交汇）",
    },
    ...
    "SEARCH_DAGUANYUAN": {
        "year_offset": 15,
        "desc": "中秋前夕抄检大观园；晴雯病逝；薛蟠娶夏金桂，香菱改名秋菱受虐",
    },
}
